...
> For more details on the general dependencies of the application, see the [package.json](https://github.com/PabloXT14/Rocketnotes-Web/blob/main/package.json) file.
